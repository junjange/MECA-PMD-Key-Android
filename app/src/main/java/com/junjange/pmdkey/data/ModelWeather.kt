...
data class ModelWeather (
    ...
    @SerializedName("rainType") var humidity: String = "",      // 습도
    @SerializedName("rainType") var sky: String = "",           // 하능 상태
    @SerializedName("rainType") var temp: String = "",          // 기온
    @SerializedName("rainType") var fcstTime: String = "",      // 예보시각
    )
